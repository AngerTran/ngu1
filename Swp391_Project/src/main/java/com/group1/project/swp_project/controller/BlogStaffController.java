...
@Tag(name = "Tạo Blog cho Saff", description = "Các API để tạo và quản lý bài viết")
@RestController
...
public class BlogStaffController {
    ...
    @Operation(summary = "Danh sách blog của staff", description = "các bài viết của staff sau khi viết sẽ được hiện ra ")
    @GetMapping("/my")
    @PreAuthorize("hasAuthority('Staff')")
    ...
    @Operation(summary = "Sửa bài viết", description = "Staff đc quyền sửa bài viết khi đã tạo bài")
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('Staff')")
